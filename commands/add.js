...
exports.run = async(client, message, args) => {
    ...
    message.channel.send(embed(`User ${user} has been added to the ticket.`));
    message.channel.createOverwrite(user, { SEND_MESSAGES: true, VIEW_CHANNEL: true, READ_MESSAGE_HISTORY: true });
}